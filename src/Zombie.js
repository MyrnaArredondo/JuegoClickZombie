...
Zombie = function(id, assetName, x0, y0, x1, y1, scale, angle, timeAnimation, timeDelay){
	...
	this.inputEnabled = true;
		...
		this.events.onInputDown.add( function () {
           this.kill();
           GamePlayManager.hitZombie(this.id, this.x, this.y, this.scale.x, this.angle);
	...
	Zombie.prototype.Appear = function(){
        ...
        this.tweenOut.to({ x: this.x0, y:this.y0}, this.timeAnimation, Phaser.Easing.Quadratic.Out, false, 
        	this.timeDelay);   
